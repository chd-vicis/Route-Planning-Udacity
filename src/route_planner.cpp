...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
  ...
  for(auto neighbor : (*current_node).neighbors){
    ...
    (*neighbor).f_value = (*neighbor).h_value + (*neighbor).g_value;
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
  ...
  std::cout << __LINE__ << "path number: " << path_found.size() << "\n"; 
  return path_found;
  // Multiply the distance by the scale of the map to get meters     return path_found;
}
